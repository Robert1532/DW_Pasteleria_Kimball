...
package pasteleria_dm.fac_produccion_0_1;
...
public class fac_produccion implements TalendJob {
	...
	private final String projectName = "PASTELERIA_DM";
	...
	public static class produccionStruct implements routines.system.IPersistableRow<produccionStruct> {
		final static byte[] commonByteArrayLock_PASTELERIA_DM_fac_produccion = new byte[0];
		static byte[] commonByteArray_PASTELERIA_DM_fac_produccion = new byte[0];
		...
		public BigDecimal TIEMPO_PRODUCCION;

		public BigDecimal getTIEMPO_PRODUCCION() {
			return this.TIEMPO_PRODUCCION;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PASTELERIA_DM_fac_produccion) {
				...
				try {
					...
					this.TIEMPO_PRODUCCION = (BigDecimal) dis.readObject();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.TIEMPO_PRODUCCION);
		...
		public String toString() {
			...
			sb.append(",TIEMPO_PRODUCCION=" + String.valueOf(TIEMPO_PRODUCCION));
		 ...
		 * Compare keys
		 */
		public int compareTo(produccionStruct other) {
	...
	public void tWaitForFile_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				produccionStruct produccion = new produccionStruct();
				...
				while (true) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("produccion", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "produccion");
					}
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:9Tg2h0eTZnJAO0V1V6j9So48V2yI+kGcllGBFmeVICY23D7m4/DO0g==");
					...
					String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
							+ " (ID_TIEMPO,ID_PRODUCTO,ID_SUCURSAL,ID_EMPLEADO,CANTIDAD_PROD,COSTO_MP,TIEMPO_PRODUCCION,MERMA) VALUES (?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
					produccionStruct produccion_tmp = new produccionStruct();
// ###############################
							...
							try {
								...
								if (temp.length() > 0) {
									...
									try {
										...
										row1.TIEMPO_PRODUCCION = ParserUtils.parseTo_BigDecimal(temp);
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"TIEMPO_PRODUCCION", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}

								} else {

									row1.TIEMPO_PRODUCCION = null;
...
// # Output table : 'produccion'
									produccion_tmp.ID_TIEMPO = row1.ID_TIEMPO;
									produccion_tmp.ID_PRODUCTO = row1.ID_PRODUCTO;
									produccion_tmp.ID_SUCURSAL = row1.ID_SUCURSAL;
									produccion_tmp.ID_EMPLEADO = row1.ID_EMPLEADO;
									produccion_tmp.CANTIDAD_PROD = row1.CANTIDAD_PROD;
									produccion_tmp.COSTO_MP = row1.COSTO_MP;
									produccion_tmp.TIEMPO_PRODUCCION = row1.TIEMPO_PRODUCCION;
									produccion_tmp.MERMA = row1.MERMA;
									produccion = produccion_tmp;
// ###############################
...
// Start of branch "produccion"
								if (produccion != null) {
									...
									pstmt_tDBOutput_1.setBigDecimal(1, produccion.ID_TIEMPO);

									pstmt_tDBOutput_1.setBigDecimal(2, produccion.ID_PRODUCTO);

									pstmt_tDBOutput_1.setBigDecimal(3, produccion.ID_SUCURSAL);

									pstmt_tDBOutput_1.setBigDecimal(4, produccion.ID_EMPLEADO);

									pstmt_tDBOutput_1.setBigDecimal(5, produccion.CANTIDAD_PROD);

									pstmt_tDBOutput_1.setBigDecimal(6, produccion.COSTO_MP);

									pstmt_tDBOutput_1.setBigDecimal(7, produccion.TIEMPO_PRODUCCION);

									pstmt_tDBOutput_1.setBigDecimal(8, produccion.MERMA);
...
// ###############################      
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "produccion");
					}
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String from_tSendMail_1 = ("vivianvillarroel5@gmail.com");
				String to_tSendMail_1 = ("vivianvillarroel153@gmail.com").replace(";", ",");
				...
				String message_tSendMail_1 = (("Archivo cargado correctamente") == null
						|| "".equals("Archivo cargado correctamente")) ? "\"\"" : ("Archivo cargado correctamente");
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:KG/dZuJHBAucUFoh7bqrOLZuWXUItmGF2ww+RtFWsgRvJw8zOJPQcuKgpfNL0ck=");

									return new javax.mail.PasswordAuthentication("vivianvillarroel5@gmail.com",
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fac_produccion.class.getClassLoader()
					.getResourceAsStream("pasteleria_dm/fac_produccion_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 90199 characters generated by Talend Open Studio for Data Integration on the
 * 11 de diciembre de 2025, 12:54:02 BOT
 ************************************************************************************************/