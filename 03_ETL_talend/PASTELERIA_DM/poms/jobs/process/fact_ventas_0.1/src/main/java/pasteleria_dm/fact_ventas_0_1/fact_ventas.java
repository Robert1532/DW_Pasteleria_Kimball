...
package pasteleria_dm.fact_ventas_0_1;
...
public class fact_ventas implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fact_ventas.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class fac_ventasStruct implements routines.system.IPersistableRow<fac_ventasStruct> {
		final static byte[] commonByteArrayLock_PASTELERIA_DM_fact_ventas = new byte[0];
		static byte[] commonByteArray_PASTELERIA_DM_fact_ventas = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PASTELERIA_DM_fact_ventas) {
				...
				try {
					...
					this.TOTAL_VENTA = (BigDecimal) dis.readObject();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.TOTAL_VENTA);
		 ...
		 * Compare keys
		 */
		public int compareTo(fac_ventasStruct other) {
	...
	public void tWaitForFile_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fac_ventasStruct fac_ventas = new fac_ventasStruct();
				...
				while (true) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("fac_ventas", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "fac_ventas");
					}
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:s9ntHuG1mGeguWRF/xu62u4KW21O+8oEuiP/Xb7G3yWFtAhV19wgWA==");
					...
					String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
							+ " (ID_TIEMPO,ID_PRODUCTO,ID_CLIENTE,ID_SUCURSAL,CANTIDAD,TOTAL_VENTA,DESCUENTO) VALUES (?,?,?,?,?,?,?)";
...
// # Outputs initialization
					fac_ventasStruct fac_ventas_tmp = new fac_ventasStruct();
// ###############################
							...
							try {
								...
								if (temp.length() > 0) {
									...
									try {
										...
										row1.total_venta = ParserUtils.parseTo_BigDecimal(temp);
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"total_venta", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}

								} else {

									row1.total_venta = null;
								...
								if (temp.length() > 0) {
									...
									try {
										...
										row1.descuento = ParserUtils.parseTo_BigDecimal(temp);
										...
										rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
												"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"descuento", "row1", temp, ex_tFileInputDelimited_1),
												ex_tFileInputDelimited_1));
									}
...
// # Output table : 'fac_ventas'
									fac_ventas_tmp.ID_TIEMPO = row1.id_tiempo;
									fac_ventas_tmp.ID_PRODUCTO = row1.id_producto;
									fac_ventas_tmp.ID_CLIENTE = row1.id_cliente;
									fac_ventas_tmp.ID_SUCURSAL = row1.id_sucursal;
									fac_ventas_tmp.CANTIDAD = row1.cantidad;
									fac_ventas_tmp.TOTAL_VENTA = row1.total_venta;
									fac_ventas_tmp.DESCUENTO = row1.descuento;
									fac_ventas = fac_ventas_tmp;
// ###############################
...
// Start of branch "fac_ventas"
								if (fac_ventas != null) {
									...
									pstmt_tDBOutput_1.setBigDecimal(1, fac_ventas.ID_TIEMPO);

									pstmt_tDBOutput_1.setBigDecimal(2, fac_ventas.ID_PRODUCTO);

									pstmt_tDBOutput_1.setBigDecimal(3, fac_ventas.ID_CLIENTE);

									pstmt_tDBOutput_1.setBigDecimal(4, fac_ventas.ID_SUCURSAL);

									pstmt_tDBOutput_1.setBigDecimal(5, fac_ventas.CANTIDAD);

									pstmt_tDBOutput_1.setBigDecimal(6, fac_ventas.TOTAL_VENTA);

									pstmt_tDBOutput_1.setBigDecimal(7, fac_ventas.DESCUENTO);
...
// ###############################      
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "fac_ventas");
					}
	...
	public void tSendMail_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String message_tSendMail_1 = (("Cargado correctamente") == null || "".equals("Cargado correctamente"))
						? "\"\""
							...
							new javax.mail.Authenticator() {
								protected javax.mail.PasswordAuthentication getPasswordAuthentication() {
									...
									final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
											.decryptPassword(
													"enc:routine.encryption.key.v1:Ou+BKOLp6Umo3VZdxW4fc+HIDfn5WlXNBCRu/LVhm2Oli57V4tlKER02shDQvTM=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = fact_ventas.class.getClassLoader()
					.getResourceAsStream("pasteleria_dm/fact_ventas_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fact_ventas.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_ventas");
		}
...
/************************************************************************************************
 * 88001 characters generated by Talend Open Studio for Data Integration on the
 * 11 de diciembre de 2025, 12:51:06 BOT
 ************************************************************************************************/